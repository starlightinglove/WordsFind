package com.yorhp.wordfindlibrary;
...
public class Predictor {
    ...
    protected long[] inputShape = new long[]{1, 3, 1080};
    ...
    public List<OcrResult> runModel() {
    ...
    private List<OcrResult> postprocess(ArrayList<OcrResultModel> results) {
        ...
        for (OcrResultModel r : results) {
            ...
            ocrResult.setTxt(r.getLabel());
            ocrResult.setConfidence(r.getConfidence());
            Rect rect = new Rect(r.getPoints().get(0).x, r.getPoints().get(0).y, r.getPoints().get(1).x, r.getPoints().get(2).y);
