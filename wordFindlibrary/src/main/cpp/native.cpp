...
Java_com_yorhp_wordfindlibrary_OCRPredictorNative_init(
...
Java_com_yorhp_wordfindlibrary_OCRPredictorNative_forward(
...
Java_com_yorhp_wordfindlibrary_OCRPredictorNative_release(
